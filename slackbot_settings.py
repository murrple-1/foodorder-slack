...
from cron import parseCronSchedule
...
ANNOUNCE_CRON_SCHEDULE_TIMES = [parseCronSchedule('0 10 * * 4')] # list of CronScheduleTime: "[minute|*] [hour|*] [day_of_month|*] [month|*] [day_of_week|*]"
